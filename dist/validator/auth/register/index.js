...
exports.registerValidator = [
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        user = _b.sent();
                        if (user) {
                            return [2 /*return*/, Promise.reject("User is existed with the email: " + email)];
                        }
                        return [2 /*return*/, true];
                    case 2:
                        err_1 = _b.sent();
                        return [2 /*return*/, Promise.reject("Server Internal Error")];
    ...
    (0, express_validator_1.body)('password').not().isEmpty().withMessage("Password is required")
        ...
        var req = _a.req;
        var isValidPassword = regex_1.PASSWORD_REGEX.test(password);
        if (!isValidPassword) {
